...
def dino_vits16(pretrained=True, **kwargs):
    ...
    """
    model = vit_o.__dict__["vit_small"](patch_size=16, num_classes=0, **kwargs)
    if pretrained:
...
def dino_vits8(pretrained=True, **kwargs):
    ...
    """
    model = vit_o.__dict__["vit_small"](patch_size=8, num_classes=0, **kwargs)
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
def dino_vitb16(pretrained=True, **kwargs):
    ...
    """
    model = vit_o.__dict__["vit_base"](patch_size=16, num_classes=0, **kwargs)
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
def dino_vitb8(pretrained=True, **kwargs):
    ...
    """
    model = vit_o.__dict__["vit_base"](patch_size=8, num_classes=0, **kwargs)
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
